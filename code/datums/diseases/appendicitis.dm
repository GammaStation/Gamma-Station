...
/datum/disease/appendicitis/stage_act()
	...
	if(stage == 1)
		if(affected_mob.op_stage.appendix == 2.0)
			...
			src.cure()
		if(prob(5))
			WARNING(affected_mob, "You feel a stinging pain in your abdomen!")
			affected_mob.emote("me",1,"winces slightly.")
	if(stage > 1)
		if(prob(3))
			WARNING(affected_mob, "You feel a stabbing pain in your abdomen!")
	...
	if(stage > 2)
		if(prob(1))
			if (affected_mob.nutrition > 100)
				...
				WARNING(affected_mob, "You gag as you want to throw up, but there's nothing in your stomach!")
				affected_mob.Weaken(10)
				affected_mob.adjustToxLoss(3)
	if(stage > 3)
		if(prob(1) && ishuman(affected_mob))
			var/mob/living/carbon/human/H = affected_mob
			WARNING(H, "Your abdomen is a world of pain!")
			H.Weaken(10)
