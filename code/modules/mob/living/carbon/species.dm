...
/datum/unarmed_attack
	...
	var/edge = 0
	var/dam_type = BRUTE
	var/no_damage = FALSE              // Makes attacks not deal any damage at all.

/datum/unarmed_attack/proc/damage_flags()
	return (sharp ? DAM_SHARP : 0) | (edge ? DAM_EDGE : 0)

/datum/unarmed_attack/proc/special_effects(mob/living/carbon/human/attacker, mob/living/victim)
	return
...
/datum/species/tycheon/regen(mob/living/carbon/human/H, emp_severity)
