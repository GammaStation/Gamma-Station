/mob/living/carbon/human
	...
	//Diona stuff	var/data = 0	var/heal_time = 0
	//Tycheon stuff.	var/metal_bending = FALSE	var/falling = 0 // Their alternative to WEAKEN. Flying mob whose falling stat is higher than 0 is not counted as flying.