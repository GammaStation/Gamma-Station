/mob/living/carbon/human/examine(mob/user)
	...
	if(w_uniform && !skipjumpsuit)
		...
		if(w_uniform.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(w_uniform)] [w_uniform.gender==PLURAL?"some":"a"] [get_mess_desc(w_uniform.blood_color)]-stained [w_uniform.name][tie_msg]!</span>\n"
	...
	if(head)
		if(head.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(head)] [head.gender==PLURAL?"some":"a"] [get_mess_desc(head.blood_color)]-stained [head.name] on [t_his] head!</span>\n"
		else if(head.wet)
	...
	if(wear_suit)
		if(wear_suit.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(wear_suit)] [wear_suit.gender==PLURAL?"some":"a"] [get_mess_desc(wear_suit.blood_color)]-stained [wear_suit.name]!</span>\n"
		...
		if(s_store && !skipsuitstorage)
			if(s_store.blood_DNA)
				msg += "<span class='warning'>[t_He] [t_is] carrying [bicon(s_store)] [s_store.gender==PLURAL?"some":"a"] [get_mess_desc(s_store.blood_color)]-stained [s_store.name] on [t_his] [wear_suit.name]!</span>\n"
			else
	...
	if(back)
		if(back.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(back)] [back.gender==PLURAL?"some":"a"] [get_mess_desc(back.blood_color)]-stained [back] on [t_his] back.</span>\n"
		else if(back.wet)
	...
	if(l_hand && !(l_hand.flags&ABSTRACT))
		if(l_hand.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] holding [bicon(l_hand)] [l_hand.gender==PLURAL?"some":"a"] [get_mess_desc(l_hand.blood_color)]-stained [l_hand.name] in [t_his] left hand!</span>\n"
		else if(l_hand.wet)
	...
	if(r_hand && !(r_hand.flags&ABSTRACT))
		if(r_hand.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] holding [bicon(r_hand)] [r_hand.gender==PLURAL?"some":"a"] [get_mess_desc(r_hand.blood_color)]-stained [r_hand.name] in [t_his] right hand!</span>\n"
		else if(r_hand.wet)
	...
	if(gloves && !skipgloves)
		if(gloves.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(gloves)] [gloves.gender==PLURAL?"some":"a"] [get_mess_desc(gloves.blood_color)]-stained [gloves.name] on [t_his] hands!</span>\n"
		else if(gloves.wet)
		...
		msg += "<span class='warning'>[t_He] [t_has] [get_mess_desc(hand_blood_color)]-stained hands!</span>\n"
	...
	if(belt)
		if(belt.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(belt)] [belt.gender==PLURAL?"some":"a"] [get_mess_desc(belt.blood_color)]-stained [belt.name] about [t_his] waist!</span>\n"
		else if(belt.wet)
	...
	if(shoes && !skipshoes)
		if(shoes.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_is] wearing [bicon(shoes)] [shoes.gender==PLURAL?"some":"a"] [get_mess_desc(shoes.blood_color)]-stained [shoes.name] on [t_his] feet!</span>\n"
		else if(shoes.wet)
		...
		msg += "<span class='warning'>[t_He] [t_has] [get_mess_desc(feet_blood_color)]-stained feet!</span>\n"

	//mask
	if(wear_mask && !skipmask)
		if(wear_mask.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(wear_mask)] [wear_mask.gender==PLURAL?"some":"a"] [get_mess_desc(wear_mask.blood_color)]-stained [wear_mask.name] on [t_his] face!</span>\n"
	...
	if(glasses && !skipeyes)
		if(glasses.blood_DNA)
			msg += "<span class='warning'>[t_He] [t_has] [bicon(glasses)] [glasses.gender==PLURAL?"some":"a"] [get_mess_desc(glasses.blood_color)]-stained [glasses] covering [t_his] eyes!</span>\n"
		else if(glasses.wet)
...
/proc/hasHUD(mob/M, hudtype)
	...
	//Пошла жара
/proc/get_mess_desc(blood_color)
	var/desc = "blood"
	if(blood_color == "#030303")
		desc = "oil"
	else if(blood_color == POOP_COLOR)
		desc = "shit"
	return desc