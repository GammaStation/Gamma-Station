/mob/living/simple_animal/hostile/hellspawn/zombie/cargo
	...
	range_weapon = list(/obj/item/weapon/gun/projectile/shotgun,/obj/item/weapon/gun/projectile/revolver/doublebarrel)
	spawn_coeff = 5

/mob/living/simple_animal/hostile/hellspawn/zombie/cargo/generate_icons()
	..()
	var/image/gear = image('icons/mob/hellspawn/zombie_gear.dmi', "cargo_[pick(1)]-[pick("a","b","c")]")
	overlays += gear
