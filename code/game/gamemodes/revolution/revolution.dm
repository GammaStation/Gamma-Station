...
/datum/game_mode/revolution
	...
	role_type = ROLE_REV
	restricted_jobs = list("Police Officer", "Sergeant", "Detective", "AI", "Cyborg","Captain", "Head of Personnel", "Marshall", "Chief Engineer", "Research Director", "Chief Medical Officer", "Internal Affairs Agent")
	required_players = 4
