...
/datum/game_mode/wizardwars/post_setup()
	...
	redwizard.add_spell(/obj/effect/proc_holder/magic/click_on/forcewall)
	redwizard.add_spell(/obj/effect/proc_holder/magic/click_on/shoot/soulspark)
	...
	redwizard.add_spell(/obj/effect/proc_holder/magic/click_on/haze)
	redwizard.add_spell(/obj/effect/proc_holder/magic/click_on/shoot/lash)

	equip_wizard(bluewizard.current)
	name_wizard(bluewizard.current)
	greet_wizard(bluewizard)
	bluewizard.add_spell(/obj/effect/proc_holder/magic/click_on/forcewall)
	bluewizard.add_spell(/obj/effect/proc_holder/magic/click_on/shoot/soulspark)
	...
	bluewizard.add_spell(/obj/effect/proc_holder/magic/click_on/haze)
	bluewizard.add_spell(/obj/effect/proc_holder/magic/click_on/shoot/lash)
