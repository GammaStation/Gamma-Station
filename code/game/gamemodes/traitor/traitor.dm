...
/datum/game_mode/traitor
	...
	protected_jobs = list("Internal Affairs Agent", "Police Officer", "Sergeant", "Detective", "Head of Security", "Captain")//AI", Currently out of the list as malf does not work for shit
	required_players = 1
	required_enemies = 1
