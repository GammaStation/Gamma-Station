...
/turf/unsimulated/floor/self_cleaning
	var/list/uncleanable_items = list(/mob/living, /obj/item/thunder_dog_tag, /mob/dead/observer, /obj/effect/landmark, /obj/effect/light_emitter, /obj/item/weapon, /obj/structure, /obj/machinery) //We dont want this items to be deleted
