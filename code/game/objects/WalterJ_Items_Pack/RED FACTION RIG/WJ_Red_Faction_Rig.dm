/obj/item/clothing/head/helmet/space/rig/RF_mining
	...
	armor = list(melee = 40, bullet = 10, laser = 10,energy = 5, bomb = 50, bio = 100, rad = 50, telepathy = 15)
...
/obj/item/clothing/suit/space/rig/RF_mining
	...
	armor = list(melee = 40, bullet = 11, laser = 10,energy = 5, bomb = 50, bio = 100, rad = 50, telepathy = 20)
