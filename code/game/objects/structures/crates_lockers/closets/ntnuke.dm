/obj/structure/closet/ntnuke
	name = "armoury closet"
	desc = "Why is this here?"
	icon_state = "ntnuke"
	icon_closed = "ntnuke"
	icon_opened = "ntnukeopen"


/obj/structure/closet/ntnuke/personal
	desc = "It's a storage unit for Nanotrasen operative gear."

/obj/structure/closet/ntnuke/personal/PopulateContents()
	new /obj/item/clothing/glasses/night(src)
	new /obj/item/clothing/under/syndicate(src)
	new /obj/item/weapon/crowbar/red(src)
	new /obj/item/weapon/storage/belt/military(src)
	new /obj/item/clothing/gloves/combat(src)
	new /obj/item/clothing/accessory/storage/nt_vest(src)
	new /obj/item/clothing/mask/gas(src)


/obj/structure/closet/ntnuke/nuclear
	desc = "It's a storage unit for Nanotrasen nuclear-operative gear."
