/obj/random/syndie/fullhouse/item_to_spawn()
	...
	prob(4);/obj/item/weapon/gun/projectile/automatic/om36,\
	...
	prob(50);/obj/item/ammo_box/magazine/m9mm_pistol,\
