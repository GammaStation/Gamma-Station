...
var/location = 0 // 0 - Start 2 - SFS Gamma 1 - transit
var/moving = 0
...
/obj/machinery/computer/arrival_shuttle
	...
	icon_state = "wagon"
	var/arrival_note = "Arrival shuttle docked with the SFS Gamma."
	var/department_note = "Arrival shuttle left the SFS Gamma."
